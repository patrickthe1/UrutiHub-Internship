-- Corrected Seed Script for Uruti Hub Internship Dashboard
-- This script populates the database with realistic test data
-- Execute after the schema has been created

-- Clear existing data to avoid conflicts
TRUNCATE submissions RESTART IDENTITY CASCADE;
TRUNCATE intern_tasks RESTART IDENTITY CASCADE;
TRUNCATE tasks RESTART IDENTITY CASCADE;
TRUNCATE interns RESTART IDENTITY CASCADE;
TRUNCATE users RESTART IDENTITY CASCADE;

-- Insert users: 1 admin and 5 intern users
-- Note: password_hash is verified bcrypt hash of 'password123' with 10 salt rounds
INSERT INTO users (email, password_hash, role) VALUES 
('admin@urutihub.com', '$2b$10$zYBrTXK3eI0aPlPXPNDlmeHJgSsg5wVgRz30FtiO4aoJwMWZzlXAW', 'admin'),  -- password: password123
('john.doe@gmail.com', '$2b$10$zYBrTXK3eI0aPlPXPNDlmeHJgSsg5wVgRz30FtiO4aoJwMWZzlXAW', 'intern'), -- password: password123
('jane.smith@gmail.com', '$2b$10$zYBrTXK3eI0aPlPXPNDlmeHJgSsg5wVgRz30FtiO4aoJwMWZzlXAW', 'intern'), -- password: password123
('alex.johnson@gmail.com', '$2b$10$zYBrTXK3eI0aPlPXPNDlmeHJgSsg5wVgRz30FtiO4aoJwMWZzlXAW', 'intern'), -- password: password123
('maria.garcia@gmail.com', '$2b$10$zYBrTXK3eI0aPlPXPNDlmeHJgSsg5wVgRz30FtiO4aoJwMWZzlXAW', 'intern'), -- password: password123
('david.lee@gmail.com', '$2b$10$zYBrTXK3eI0aPlPXPNDlmeHJgSsg5wVgRz30FtiO4aoJwMWZzlXAW', 'intern'); -- password: password123
